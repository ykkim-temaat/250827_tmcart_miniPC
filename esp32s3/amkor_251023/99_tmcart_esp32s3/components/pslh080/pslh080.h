...
// 0점 조절 GPIO 변경(2025.11.10): GPIO_NUM_0 -> (input_24 & 0x80) == 0
...
// input_24 & 0x80 == 0 일 때의 위치가 539.000mm (2025.11.10 수정) - 1호기
// #define INITIAL_PULSE_COUNT         (539000)  // 초기 펄스 카운트 값 (539.000mm 위치로 변경)

// input_24 & 0x80 == 0 일 때의 위치가 534.000mm (2026.05.26 수정) - 2호기
#define INITIAL_PULSE_COUNT         (534000)  // 초기 펄스 카운트 값 (534.000mm 위치로 변경)
